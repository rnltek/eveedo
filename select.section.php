                ...
                <div class="row align-items-start" >
                    <div class="col-md-12 col-xs-12">
                        <div class="row align-items-start" >
                            ...
                            <?php
                            include ("inc.config.php");
                            $qsection = "SELECT * FROM `sections` where `section_name` <> 'News' AND `section_parent`='0' ORDER BY `section_name` ASC";
                            $rsection = $connect->query($qsection);
                            while ($section = mysqli_fetch_array($rsection)){
                            ?>
                            <div class="col">
                                <a href="select.section.expanded.php?i=<?php echo $section['section_id'];?>&r=<?php echo $_GET['r'];?>&t=<?php echo $_GET['t'];?>&f=<?php echo $_GET['f'];?>">
