...
<html lang="en">
    ...
    <body style="background-color:#0240a8;background:#0240a8;">
            ...
            <div class="row" style="height:100%;margin-top:-1px;">
                <div class="col-md-12 col-xs-12" style="padding-left:25px;padding-top:25px;">
                    <div style="margin:auto;width:250px;margin-top:50px;">
                        <form action="do/do.register.php" method="post">
                            <p align="center">
                                <img src="logo.png"/>
                            </p>
                            <p>
                            ...
                            <p>
                                <input type="password" name="password" id="password" class="form-control" placeholder="Create Password" requried/>
                            </p>
                            <p>
                            ...
                            <p align="center">
                                <a href="/" class="btn btn-warning btn-block">Have an Account? Login.</a>
                            </p>
                            <p align="center">
                                <a href="forgot.password.php" class="btn btn-default btn-block">Forgot Password? Reset.</a>
                            </p>
                        </form>
                    </div>
                </div>
