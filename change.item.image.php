...
<html lang="en">
    ...
    <body style="background:#ffffff;background-color:#ffffff;">
        ...
        <form action="do/do.item.icon.upload.php" method="POST" enctype="multipart/form-data">
        <div class="container" style="margin-top:125px;">
            <div class="row" style="margin-bottom:15px;">
                <div class="col-md-12">
                    <h4><?php echo $item['item_name'];?> (Change Image)</h4>
                </div>
            </div>
            <div class="row align-items-start" style="margin-bottom:25px;">
                ...
                <div class="col-md-6">
                    <input type="hidden" name="item" id="item" value="<?php echo $_GET['t'];?>"/>
                    <p>
