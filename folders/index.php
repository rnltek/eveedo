        ...
        <div class="container-fluid" style="height:100%;">
            ...
            <div class="row" style="height:100%;margin-top:-1px;">
                <div class="col-md-11 col-xs-10" style="padding-left:25px;padding-top:25px;">
                    <h1 style="color:#0240a8;">Folders</h1>
                    <p>
                        <a href="/folders/create.parent.folder.1.php"><span class="fa fa-plus fa-lg"></span>&nbsp;Add Folder</a>
                    </p>
                    <section id="pinBoot">
                        <?php
                        include("../inc.config.php");
                        $qfolders = "SELECT * FROM `folders` WHERE `owner`='$ecn' AND `parent`='0' ORDER BY `title` ASC";
                        $rfolders = $connect->query($qfolders);
                        while($folder = mysqli_fetch_array($rfolders)){
                        ?>
                        <article class="white-panel">
                            <p style="margin:0px;padding:0px;">
                                <span class="fa fa-folder fa-lg" style="width:auto;font-size:24px;line-height:32px;margin:4px;"></span>
