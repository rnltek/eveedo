...
<html lang="en">
    <head>
        ...
        <form action="add.link.2.php" method="POST">
            <div class="row">
                <div class="col">
                    <h4>Add Website</h4>
                </div>
            ...
            <div class="row align-items-start">
                <div class="col-md-6">
                    <p>
                    Enter Link to website or page
                    <input type="hidden" name="folder" id="folder" value="<?php echo $_GET['t'];?>"/>
                    <input type="url" name="url" id="url" class="form-control form-control-lg" placeholder="Enter url to website or page"/>
                    </p>
                </div>
                <div class="col-md-6">
                    <table width="100%" style="margin-bottom:15px;">
                        <tr>
                            <td>Section
                                ...
                                <input type="hidden" name="section_image" id="section_image" value="<?php echo @$_SESSION['working_image'];?>"/>
                                <input type="hidden" name="section_color" id="section_color" value="<?php echo @$_SESSION['working_color'];?>"/>
                            </td>
                            <td width="48" valign="middle">
                                <span onclick="window.location='select.section.php?r=add.link&t=<?php echo $_GET['t'];?>';" class="fa fa-search-plus fa-lg" style="color:#0240a8;font-size:32px;cursor:pointer;width:32px;text-align:center;"></span>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="row align-items-start">
                ...
                <div class="col-md-6">
                    <p>
                    <input type="submit" value="Continue" class="btn btn-success btn-block btn-lg" style=""/>
                    </p>
                </div>
            </div>
            <div class="row" style="">
