    ...
    <head>
        ...
        <div class="container" style="margin-top:125px;">
            ...
            <div class="row align-items-start" style="margin-bottom:25px;">
                <div class="col-md-2"><p><img src="images/Icon_Products_Word_68x68.jpg"/></p><p>Add a Microsoft Word file to this folder.</p></div>
                <div class="col-md-6">
                    <input type="hidden" name="folder" id="folder" value="<?php echo $_GET['t'];?>"/>
                    <p>
                        Select File
                    <input type="file" name="fileToUpload" id="fileToUpload" class="file-control" style="" accept=".doc,.docx">
                    </p>
                    <p>
                        Item Name/Title
                    ...
                    <table width="100%" style="margin-bottom:15px;">
                        <tr>
                            ...
                            <td width="48" valign="middle">
                                <span onclick="window.location='select.section.php?r=add.word&t=<?php echo $_GET['t'];?>';" class="fa fa-search-plus fa-lg" style="color:#0240a8;font-size:32px;cursor:pointer;width:32px;text-align:center;"></span>
                            </td>
                        </tr>
                    </table>
                    <p>
