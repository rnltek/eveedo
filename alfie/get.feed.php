...
// Global News RSS converter
$url = "http://www.hngn.com/rss/sections/world.xml";
...
// Global News RSS converter
$url = "http://www.hngn.com/rss/sections/politics.xml";
$xml = simplexml_load_file($url);
for($i = 0; $i < 50; $i++){
    if(@$xml->channel->item[$i]->title>'0'){
        $title = $xml->channel->item[$i]->title;
...
// Global News RSS converter
$url = "http://www.hngn.com/rss/sections/business.xml";
$xml = simplexml_load_file($url);
for($i = 0; $i < 50; $i++){
    if(@$xml->channel->item[$i]->title>'0'){
        $title = $xml->channel->item[$i]->title;
...
// Global News RSS converter
$url = "http://www.hngn.com/rss/sections/sports.xml";
$xml = simplexml_load_file($url);
for($i = 0; $i < 50; $i++){
    if(@$xml->channel->item[$i]->title>'0'){
        $title = $xml->channel->item[$i]->title;
...
// Global News RSS converter
$url = "http://www.hngn.com/rss/sections/entertainment.xml";
$xml = simplexml_load_file($url);
for($i = 0; $i < 50; $i++){
    if(@$xml->channel->item[$i]->title>'0'){
        $title = $xml->channel->item[$i]->title;
...
// Global News RSS converter
$url = "http://www.hngn.com/rss/sections/tech.xml";
$xml = simplexml_load_file($url);
for($i = 0; $i < 50; $i++){
    if(@$xml->channel->item[$i]->title>'0'){
        $title = $xml->channel->item[$i]->title;
...
// Global News RSS converter
$url = "http://www.hngn.com/rss/sections/life-style.xml";
$xml = simplexml_load_file($url);
for($i = 0; $i < 50; $i++){
    if(@$xml->channel->item[$i]->title>'0'){
        $title = $xml->channel->item[$i]->title;
...
// Global News RSS converter
$url = "http://www.hngn.com/rss/sections/science.xml";
$xml = simplexml_load_file($url);
for($i = 0; $i < 50; $i++){
    if(@$xml->channel->item[$i]->title>'0'){
        $title = $xml->channel->item[$i]->title;
...
// Global News RSS converter
$url = "http://www.hngn.com/rss/sections/health.xml";
$xml = simplexml_load_file($url);
for($i = 0; $i < 50; $i++){
    if(@$xml->channel->item[$i]->title>'0'){
        $title = $xml->channel->item[$i]->title;
...
// Global News RSS converter
$url = "http://www.health.com/family/feed";
$xml = simplexml_load_file($url);
for($i = 0; $i < 50; $i++){
    if(@$xml->channel->item[$i]->title>'0'){
        $title = $xml->channel->item[$i]->title;
...
// Global News RSS converter
$url = "https://www.internetsociety.org/headlines/rss";
$xml = simplexml_load_file($url);
for($i = 0; $i < 50; $i++){
    if(@$xml->channel->item[$i]->title>'0'){
        $title = $xml->channel->item[$i]->title;
...
// Global News RSS converter
$url = "http://feeds.feedburner.com/seriouseatsfeaturesvideos";
$xml = simplexml_load_file($url);
for($i = 0; $i < 50; $i++){
    if(@$xml->channel->item[$i]->title>'0'){
        $title = $xml->channel->item[$i]->title;
...
// Global News RSS converter
$url = "http://www.beautyworldnews.com/rss/sections/fashion.xml";
$xml = simplexml_load_file($url);
for($i = 0; $i < 50; $i++){
    if(@$xml->channel->item[$i]->title>'0'){
        $title = $xml->channel->item[$i]->title;
...
// Global News RSS converter
$url = "https://www.realwire.com/rss/?id=237&row=&view=Synopsis";
$xml = simplexml_load_file($url);
for($i = 0; $i < 50; $i++){
    if(@$xml->channel->item[$i]->title>'0'){
        $title = $xml->channel->item[$i]->title;
