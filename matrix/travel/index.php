        ...
        <div class="container-fluid" style="height:100%;">
            ...
            <div class="row" style="height:100%;margin-top:-1px;">
                <div class="col-md-11 col-xs-10" style="padding-left:25px;padding-top:25px;">
                    <h1 style="color:#f2f2f2;">Travel</h1>
                    <section id="pinBoot">
                        <?php
                        include("../../inc.config.php");
                        $qitems = "SELECT * FROM `matrix` WHERE `section`='Travel' ORDER BY `pubdateyear` DESC,`pubdatemonth` DESC,`pubdateday` DESC,`pubdatehour` DESC,`pubdateminute` DESC LIMIT 0,24";
                        $ritems = $connect->query($qitems);
                        while($item = mysqli_fetch_array($ritems)){
                            $source_icon = "images/travel.png";
                        ?>
