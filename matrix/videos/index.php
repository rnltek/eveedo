...
<html lang="en">
    ...
    <body>
        <div class="container-fluid" style="height:100%;">
            <div class="row" style="margin-bottom:0px;position:fixed;top:0px;width:100%;">
            ...
            <div class="row" style="height:100%;margin-top:-1px;">
                <div class="col-md-11 col-xs-10" style="padding-left:25px;padding-top:25px;z-index:-1;">
                    <h1 style="color:#f2f2f2;">Videos</h1>
                    <section id="pinBoot">
                        <?php
                        include("../../inc.config.php");
                        $qitems = "SELECT * FROM `matrix` WHERE `section`='Videos' ORDER BY `pubdateyear` DESC,`pubdatemonth` DESC,`pubdateday` DESC,`pubdatehour` DESC,`pubdateminute` DESC";
                        $ritems = $connect->query($qitems);
                        while($item = mysqli_fetch_array($ritems)){
                            $source_icon = "images/videos.png";
                        ?>
                ...
                <div class="col-md-1 col-xs-2" style="background:#000000;height:100%;position:fixed;right:0px;">
