...
$tags = eveedo_keywords($item_description);
$item_type = "Link";
$item_icon = @$og['image'];
$item_url = $url;
...
$item_token = "L".strtoupper(md5(time())).TokenGen(50);
$q = "INSERT INTO `folder_items` (`ecn`,`folder`,`item_icon`,`item_name`,`item_description`,`item_type`,`item_token`,`item_url`,`privacy`,`tags`,`section`,`section_image`,`section_color`) VALUES('".$ecn."','".mysqli_real_escape_string($connect,$folder)."','".mysqli_real_escape_string($connect,@$item_icon)."','".mysqli_real_escape_string($connect,@$item_name)."','".mysqli_real_escape_string($connect,@$item_description)."','".@$item_type."','".@$item_token."','".mysqli_real_escape_string($connect,@$item_url)."','".$privacy."','".mysqli_real_escape_string($connect,@$tags)."','".$section."','".$section_image."','".$section_color."');"; 
$connect->query($q);
//echo $q;
//$connect->query("INSERT INTO `folder_items` (`ecn`,`folder`,`item_icon`,`item_name`,`item_description`,`item_type`,`item_token`,`item_url`,`privacy`,`tags`,`section`) VALUES('".$ecn."','".mysqli_real_escape_string($connect,$folder)."','".mysqli_real_escape_string($connect,@$item_icon)."','".mysqli_real_escape_string($connect,@$item_name)."','".mysqli_real_escape_string($connect,@$item_description)."','".@$item_type."','".@$item_token."','".mysqli_real_escape_string($connect,@$item_url)."','".$privacy."','".mysqli_real_escape_string($connect,@$tags)."','".$section."');");
//header("Location:folder.php?t=$folder");
header("Location:edit.item.php?t=$item_token");
